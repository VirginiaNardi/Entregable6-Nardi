...
app.use(session({
    store: MongoStore.create({
      mongoUrl: 'mongodb+srv://virnardi1680:ijHrzCGkYgAicNmq@cluster0.jesufij.mongodb.net/',
      dbName: 'ecommerce',
      mongoOptions: {
...
try {
  await mongoose.connect('mongodb+srv://virnardi1680:ijHrzCGkYgAicNmq@cluster0.jesufij.mongodb.net/ecommerce', {
    useNewUrlParser: true,
    useUnifiedTopology: true
  });
  
    console.log('Conectado a MongoDB con éxito'); // Mensaje de éxito
